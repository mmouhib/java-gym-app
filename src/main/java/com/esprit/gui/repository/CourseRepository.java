...
//    }
    ...
    public List<Course> getCoursesByDate(String date) {
        List<Course> lst = new ArrayList<>();
        try {
            PreparedStatement ps = connection.prepareStatement("select * from course where course.startDate>=?");
    ...
    public List<Course> getCoursesByDates(String start, String end) {
        ...
        List<Course> lst = new ArrayList<>();
        try {
            PreparedStatement ps = connection.prepareStatement("select * from course where course.startDate>=? and endDate<=?");
